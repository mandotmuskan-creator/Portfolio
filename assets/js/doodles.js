...
const DOODLE = {
  ...
  logo: `<svg viewBox="0 0 40 40" class="doodle" aria-hidden="true">
    <path class="stroke stroke-thick" d="M8 31 L11 11 L20 24 L29 11 L32 31"/>
    <path d="M4 26 L11 22 L9 31 Z" fill="#FF3B2A"/>
  </svg>`,
